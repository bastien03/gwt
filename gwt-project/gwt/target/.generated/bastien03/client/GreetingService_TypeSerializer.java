...
public class GreetingService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    var result = {};
    result["bastien03.shared.DataObject/1069682334"] = [
        @bastien03.shared.DataObject_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @bastien03.shared.DataObject_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lbastien03/shared/DataObject;),
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    var result = [];
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@bastien03.shared.DataObject::class)] = "bastien03.shared.DataObject/1069682334";
